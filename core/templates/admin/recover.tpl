...
<div id="content" class="recovery">
	...
	<?php elseif (isset($_['sent'])): ?>
		<h3>Email sent</h3>
		<p>The password recovery email has been sent containing information on how to reset your password. You can go back to the <a href="/<?php echo $_['base_url']; ?>admin/login/">login</a> page.</p>
	<?php elseif (isset($_['success'])): ?>
		<h3>Password reset</h3>
		<p>Your password has successfully been reset, you can now <a href="/<?php echo $_['base_url']; ?>admin/login/">login</a> with your new password.</p>
