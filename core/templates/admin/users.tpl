	 ...
	 <div class="dropdown">
      ...
      <ul class="dropdown-menu" role="menu">
	   <li>
	    ...
	    <a href="#" class="sure" onclick="ajax('DELETE', {account_id: <?php echo $item['account_id']; ?>}, function() { hideRow(<?php echo $item['account_id']; ?>); });"><i class="icon-fixed-width icon-trash"></i>&ensp;Really?</a>
	    <?php } ?>
	   </li>
	  </ul>
	 </div>
