        ...
        toolbarTemplate = "<div class='options'> \
          <span class='no-overflow'> \
            <span class='ui-inputs'> \
              ...
              <button class='quote'><i class=\"fa fa-quote-right\"></i></button> \
  ...
  function triggerTextStyling(node) {
    ...
    for (var tag in tagClassMap) {
      ...
      if (reTag.test(className)) {
        switch(tag) {
          case "b":
            if (selNode && !hasParentWithTag(selNode, "h3") && !hasParentWithTag(selNode, "h4")) {
