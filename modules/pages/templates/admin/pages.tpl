	 ...
	 <div class="dropdown">
      ...
      <ul class="dropdown-menu" role="menu">
	   ...
	   <li>
	    ...
	    <a href="#" class="sure" onclick="ajax('DELETE', {}, '/<?php echo $_['base_url']; ?>admin/module/pages/remove/<?php echo $item['module_pages_id']; ?>/', function() { hideRow(<?php echo $item['module_pages_id']; ?>); });"><i class="icon-fixed-width icon-trash"></i>&ensp;Really?</a>
	   </li>
	  </ul>
	 </div>
	</div>
